...
while ret:
    ...
    if ret:
        ...
        cv2.namedWindow('9) YoloV11Nano Object Tracking Project', cv2.WINDOW_NORMAL)
        cv2.resizeWindow('9) YoloV11Nano Object Tracking Project', 480, 852)
        cv2.imshow('9) YoloV11Nano Object Tracking Project', frame_)
